...
from horisan.helper_extra.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Owner didnt gave you rights for that baaka!")
        return
    ...
    if user_member.status == "administrator" or user_member.status == "creator":
        message.reply_text("Baka! How i make someone admin who is already admin")
        return

    if user_id == bot.id:
        message.reply_text("I can't promote myself! do it manually lazy.")
        return
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text("Atleast add that baka here.")
        else:
    ...
    bot.sendMessage(
        chat.id,
        f"Sucessfully made <b>{user_member.user.first_name or user_id}</b> admin!",
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if user_can_promote(chat, user, context.bot.id) is False:
        message.reply_text("Owner didnt gave you these rights baaka!")
        return ""
    ...
    if user_member.status == "creator":
        message.reply_text("Demote owner? im not stupid like you!")
        return
    ...
    if user_id == bot.id:
        message.reply_text("I can't demote myself! why doing it:(.")
        return
