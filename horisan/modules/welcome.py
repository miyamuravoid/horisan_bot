    ...
    for new_mem in new_members:
        ...
        if should_welc:
           ...
           # make kontol asu
                ...
                update.effective_message.reply_text(
                        "❤️ <b>Thanks for adding hori san to the group!</b>\n\n<b>Promote hori as administrator of the group, otherwise I will not be able to work properly.</b>",
                            ...
                            [
                                {
                                    ...
                                    InlineKeyboardButton(
                                        text="sᴜᴘᴘᴏʀᴛ​",
                                        url="https://t.me/horisanbotsupport",
                                    )
                                }
                            ]
                        ),
